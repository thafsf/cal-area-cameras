...
def calculate_area_perimeter(edges, threshold_image, tape_width_meters=0.0176): # 0.0175 largura da fita de teste e 0.02 largura da fita na competição
    ...
    if contours:
        ...
        if tape_pixel_widths:
            ...
            return area_meters, perimeter_meters, avg_tape_pixel_width, med_tape_pixel_width, max_tape_pixel_width, mode_tape_pixel_width
        else:
...
def main():
    ...
    cap = cv2.VideoCapture("Video_de_teste_4.mp4")
